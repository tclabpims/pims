...
function(a, b) {
    var c = function(c, d) {
        function e(a) {
            ...
            c = b[p],
            d = v ? a.pageY: a.pageX;
            d > c + H ? (H = d - c - G + J, H > I && (H = I)) : (H = d - c - J, 0 > H && (H = 0)),
            m.update_scroll()
        }
        function f(b) {
            b.preventDefault(),
            b.stopPropagation(),
            cb = bb = v ? b.pageY: b.pageX,
            R = !0,
            a("html").off("mousemove.ace_scroll").on("mousemove.ace_scroll", g),
            a(S).off("mouseup.ace_scroll").on("mouseup.ace_scroll", h),
            B.addClass("active"),
            T && m.$element.trigger("drag.start")
        }
        function g(a) {
            a.preventDefault(),
            a.stopPropagation(),
            cb = v ? a.pageY: a.pageX,
            cb - bb + H > I ? cb = bb + I - H: 0 > cb - bb + H && (cb = bb - H),
            H += cb - bb,
            bb = cb,
            0 > H ? H = 0 : H > I && (H = I),
            m.update_scroll()
        ...
        function h(b) {
            ...
            b.stopPropagation(),
            R = !1,
            a("html").off(".ace_scroll"),
            a(S).off(".ace_scroll"),
            B.removeClass("active"),
            T && m.$element.trigger("drag.end"),
            x && X && !Z && j()
        }
        function i(a) {
            var b = +new Date;
            if ($ && b - eb > 1e3) {
                var c = A[u];
                _ != c && (_ = c, ab = !0, m.reset(!0)),
                eb = b
            }
            x && X && (null != db && (clearTimeout(db), db = null), B.addClass("not-idle"), Z || 1 != a || j())
        }
        function j() {
            null != db && (clearTimeout(db), db = null),
            db = setTimeout(function() {
                db = null,
                B.removeClass("not-idle")
            },
            Y)
        }
        function k() {
            B.css("visibility", "hidden").addClass("scroll-hover"),
            O = v ? parseInt(B.outerWidth()) || 0 : parseInt(B.outerHeight()) || 0,
            B.css("visibility", "").removeClass("scroll-hover")
        }
        function l() {
            if (W !== !1) {
                var a = z.offset(),
                b = a.left,
                c = a.top;
                v ? N || (b += z.outerWidth() - O) : N || (c += z.outerHeight() - O),
                W === !0 ? B.css({
                    top: parseInt(c),
                    left: parseInt(b)
        ...
        this.create = function(b) {
            if (!y) {
                b && (o = a.extend({},
                a.fn.ace_scroll.defaults, b)),
                this.size = parseInt(this.$element.attr("data-size")) || o.size || 200,
                v = !o.horizontal,
                p = v ? "top": "left",
                q = v ? "height": "width",
                r = v ? "maxHeight": "maxWidth",
                s = v ? "clientHeight": "clientWidth",
                t = v ? "scrollTop": "scrollLeft",
                u = v ? "scrollHeight": "scrollWidth",
                this.$element.addClass("ace-scroll"),
                "static" == this.$element.css("position") ? (Q = this.element.style.position, this.element.style.position = "relative") : Q = !1;
                var c = null;
                V ? c = a('<div class="scroll-track scroll-detached"><div class="scroll-bar"></div></div>').appendTo("body") : (this.$element.wrapInner('<div class="scroll-content" />'), this.$element.prepend('<div class="scroll-track"><div class="scroll-bar"></div></div>')),
                z = this.$element,
                V || (z = this.$element.find(".scroll-content").eq(0)),
                v || z.wrapInner("<div />"),
                A = z.get(0),
                V ? (B = c, l()) : B = this.$element.find(".scroll-track").eq(0),
                C = B.find(".scroll-bar").eq(0),
                D = B.get(0),
                E = C.get(0),
                F = E.style,
                v || B.addClass("scroll-hz"),
                o.styleClass && (M = o.styleClass, B.addClass(M), N = !!M.match(/scroll\-left|scroll\-top/)),
                0 == O && (B.show(), k()),
                B.hide(),
                B.on("mousedown", e),
                C.on("mousedown", f),
                z.on("scroll",
                function() {
                    K && (H = parseInt(Math.round(this[t] * P)), F[p] = H + "px"),
                    K = !1,
                    U && this.$element.trigger("scroll", [A])
                }),
                o.mouseWheel && (this.lock = o.mouseWheelLock, this.lock_anyway = o.lockAnyway, this.$element.on(a.event.special.mousewheel ? "mousewheel.ace_scroll": "mousewheel.ace_scroll DOMMouseScroll.ace_scroll",
                function(b) {
                    if (!w) {
                        if (i(!0), !x) return ! m.lock_anyway;
                        R && (R = !1, a("html").off(".ace_scroll"), a(S).off(".ace_scroll"), T && m.$element.trigger("drag.end")),
                        b.deltaY = b.deltaY || 0;
                        var c = b.deltaY > 0 || b.originalEvent.detail < 0 || b.originalEvent.wheelDelta > 0 ? 1 : -1,
                        d = !1,
                        e = A[s],
                        f = A[t];
                        m.lock || (d = -1 == c ? A[u] <= f + e: 0 == f),
                        m.move_bar(!0);
                        var g = parseInt(e / 8);
                        return 80 > g && (g = 80),
                        g > m.size && (g = m.size),
                ...
                X && B.addClass("idle-hide"),
                $ && B.on("mouseenter.ace_scroll",
                function() {
                    Z = !0,
                    i(!1)
                ...
                this.$element.on("mouseenter.ace_scroll touchstart.ace_scroll",
                function() {
                    ab = !0,
                    $ ? i(!0) : o.hoverReset && m.reset(!0),
                    B.addClass("scroll-hover")
                }).on("mouseleave.ace_scroll touchend.ace_scroll",
                function() {
                    B.removeClass("scroll-hover")
                }),
                v || z.children(0).css(q, this.size),
                z.css(r, this.size),
                w = !1,
                y = !0
            }
        ...
        this.reset = function(a) {
            if (!w) {
                ...
                if (!a || ab) {
                    ...
                    v || z.children(0).css(q, b),
                    z.css(r, this.size),
                    d > e ? (x = !0, B.css(q, e).show(), P = parseFloat((e / d).toFixed(5)), G = parseInt(Math.round(e * P)), J = parseInt(Math.round(G / 2)), I = e - G, H = parseInt(Math.round(A[t] * P)), F[q] = G + "px", F[p] = H + "px", B.addClass("scroll-active"), 0 == O && k(), L || (o.reset && (A[t] = 0, F[p] = 0), L = !0), V && l()) : (x = !1, B.hide(), B.removeClass("scroll-active"), z.css(r, ""))
                }
            }
        },
        ...
        this.destroy = function() {
            ...
            V || (v || z.find("> div").children().unwrap(), z.children().unwrap(), z.remove()),
            B.remove(),
            Q !== !1 && (this.element.style.position = Q),
            null != db && (clearTimeout(db), db = null)
        },
        ...
        this.update = function(c) {
            c && (o = a.extend({},
            o, c)),
            this.size = c.size || this.size,
            this.lock = c.mouseWheelLock || this.lock,
            this.lock_anyway = c.lockAnyway || this.lock_anyway,
            c.styleClass != b && (M && B.removeClass(M), M = c.styleClass, M && B.addClass(M), N = !!M.match(/scroll\-left|scroll\-top/))
        },
        this.start = function() {
            A[t] = 0
        },
    ...
    a.fn.ace_scroll = function(d, e) {
        var f, g = this.each(function() {
            ...
            g = b.data("ace_scroll"),
            h = "object" == typeof d && d;
            g || b.data("ace_scroll", g = new c(this, h)),
            "string" == typeof d && (f = g[d](e))
        });
        return f === b ? g: f
    },
...
function(a, b) {
    var c = function(b, c) {
        ...
        e = a.extend({},
        a.fn.ace_colorpicker.defaults, c, d),
        f = a(b),
        g = "",
        h = "",
        i = null,
        ...
        f.addClass("hide").find("option").each(function() {
            ...
            this.selected && (a += " selected", h = b),
            j.push(b),
            g += '<li><a class="' + a + '" href="#" style="background-color:' + b + ';" data-color="' + b + '"></a></li>'
        }).end().on("change.color",
        function() {
        ...
        k.on(ace.click_event,
        function(b) {
            var c = a(b.target);
            if (!c.is(".colorpick-btn")) return ! 1;
            i && i.removeClass("selected"),
            i = c,
            i.addClass("selected");
            var d = i.data("color");
            return f.val(d).trigger("change"),
            b.preventDefault(),
            !0
        }),
        i = f.next().find("a.selected"),
        this.pick = function(c, d) {
            if ("number" == typeof c) {
        ...
        this.destroy = function() {
            f.removeClass("hide").off("change.color").next().remove(),
            j = []
        }
    };
    a.fn.ace_colorpicker = function(d, e) {
        var f, g = this.each(function() {
            ...
            h = "object" == typeof d && d;
            g || b.data("ace_colorpicker", g = new c(this, h)),
            "string" == typeof d && (f = g[d](e))
        });
        return f === b ? g: f
    },
...
function(a, b) {
    ...
    g = function(b, c) {
        ...
        a.fn.ace_file_input.defaults, c, e),
        this.$element = a(b),
        this.element = b,
        this.disabled = !1,
        this.can_reset = !0,
        this.$element.off("change.ace_inner_call").on("change.ace_inner_call",
        function(a, b) {
        ...
        this.$element.wrap("<" + g + ' class="ace-file-input" />'),
        this.apply_settings(),
    ...
    g.prototype.apply_settings = function() {
        var b = this;
        this.multi = this.$element.attr("multiple") && c,
    ...
    g.prototype.show_file_list = function(b, c) {
        ...
        if (d && 0 != d.length) {
            this.well_style && (this.$label.find(".ace-file-name").remove(), this.settings.btn_change || this.$label.addClass("hide-placeholder")),
            ...
            for (var g = 0; g < d.length; g++) {
                ...
                if ("string" == typeof d[g]) h = d[g];
                    ...
                    h = d[g].name,
                    d[g].hasOwnProperty("type") && (i = d[g].type),
                    d[g].hasOwnProperty("path") || (d[g].path = d[g].name)
                }
                var k = h.lastIndexOf("\\") + 1;
                0 == k && (k = h.lastIndexOf("/") + 1),
                h = h.substr(k),
                0 == i && (i = /\.(jpe?g|png|gif|svg|bmp|tiff?)$/i.test(h) ? "image": /\.(mpe?g|flv|mov|avi|swf|mp4|mkv|webm|wmv|3gp)$/i.test(h) ? "video": /\.(mp3|ogg|wav|wma|amr|aac)$/i.test(h) ? "audio": "file");
                var l = {
                    file: "fa fa-file",
                    image: "fa fa-scripts.picture-o file-image",
    ...
    g.prototype.loading = function(b) {
        if (b === !1) this.$container.find(".ace-file-overlay").remove(),
        this.element.removeAttribute("readonly");
            ...
            0 == d.length && (d = a('<div class="ace-file-overlay"></div>').appendTo(this.$container), d.on("click tap",
            function(a) {
    ...
    var h = function() {
        ...
        b.off("dragenter").on("dragenter",
        function(a) {
            a.preventDefault(),
            a.stopPropagation()
        }).off("dragover").on("dragover",
        function(a) {
            a.preventDefault(),
            a.stopPropagation()
        }).off("drop").on("drop",
        function(b) {
            if (b.preventDefault(), b.stopPropagation(), !a.disabled) {
                ...
                return d = l.call(a, d, !0),
                d === !1 ? !1 : (a.$element.data("ace_input_method", "drop"), a.$element.data("ace_input_files", d), a.show_file_list(d, !0), a.$element.triggerHandler("change", [!0]), !0)
            }
        })
    },
    i = function() {
        var a = this.element.files || [this.element.value];
        return a = l.call(this, a, !1),
        a === !1 ? !1 : (this.$element.data("ace_input_method", "select"), this.$element.data("ace_input_files", a), this.show_file_list(a, !0), !0)
    },
    j = function(b) {
        var c = this,
        ...
        i = function(b) {
            var f = 50;
            "large" == c.settings.thumbnail ? f = 150 : "fit" == c.settings.thumbnail && (f = d.width()),
            d.addClass(f > 50 ? "large": "");
            var h = k(b, f);
            if (null == h) return a(this).remove(),
            void e.reject({
                code: g.error.THUMBNAIL_FAILED
            });
            var i = h.w,
            j = h.h;
            "small" == c.settings.thumbnail && (i = j = f),
            a(b).css({
    ...
    k = function(b, c) {
        ...
        d = d > 0 ? d: a(b).width(),
        e = e > 0 ? e: a(b).height(),
        (d > c || e > c) && (d > e ? (e = parseInt(c / d * e), d = c) : (d = parseInt(c / e * d), e = c));
        var f;
        try {
            ...
            h.drawImage(b, 0, 0, b.width, b.height, 0, 0, d, e),
            f = g.toDataURL()
        } catch(i) {
            f = null
        }
    ...
    o = function(b, c) {
        ...
        l = 0; l < b.length; l++) {
            var o = b[l],
            p = f ? o.name: o;
            if (!d || d.test(p)) if (e && e.test(p))"ext" in k || (k.ext = []),
            k.ext.push(p);
            else {
                var q;
                if (f) {
        ...
        "ext" in k && (r.ext = k.ext.length),
        "mime" in k && (r.mime = k.mime.length),
        "size" in k && (r.size = k.size.length);
        var s;
    ...
    a.fn.aceFileInput = a.fn.ace_file_input = function(c, d) {
        var e, f = this.each(function() {
            ...
            h = "object" == typeof c && c;
            f || b.data("ace_file_input", f = new g(this, h)),
            "string" == typeof c && (e = f[c](d))
        });
        return e === b ? f: e
    },
...
function(a) {
    ...
    a.fn.bs_typeahead = function(c) {
        return this.each(function() {
            ...
            f = "object" == typeof c && c;
            e || d.data("bs_typeahead", e = new b(this, f)),
            "string" == typeof c && e[c]()
        })
    },
    ...
    a.fn.bs_typeahead.Constructor = b,
    a.fn.bs_typeahead.noConflict = function() {
        return a.fn.bs_typeahead = c,
        this
    },
    a(document).on("focus.bs_typeahead.data-api", '[data-provide="bs_typeahead"]',
    function() {
        var b = a(this);
...
function(a) {
    a.fn.ace_wysiwyg = function(b) {
        ...
        e = {
            ...
            insertImage: {
                icon: "fa fa-scripts.picture-o",
                title: "Insert scripts.picture",
        ...
        return this.each(function() {
            ...
            for (var d in f) if (f.hasOwnProperty(d)) {
                ...
                if ("string" == typeof g && g in e) g = e[g],
                g.name = f[d];
                else {
                ...
                switch (g.name) {
                case "font":
                    b += ' <a class="btn btn-sm ' + h + ' dropdown-toggle" data-toggle="dropdown" title="' + g.title + '"><i class="' + ace.vars.icon + g.icon + '"></i><i class="' + ace.vars.icon + 'fa fa-angle-down icon-on-right"></i></a> ',
                    b += ' <ul class="dropdown-menu dropdown-light dropdown-caret">';
                ...
                case "fontSize":
                    ...
                    break;
                case "createLink":
                    b += ' <div class="btn-group"> <a class="btn btn-sm ' + h + ' dropdown-toggle" data-toggle="dropdown" title="' + g.title + '"><i class="' + ace.vars.icon + g.icon + '"></i></a> ',
                    b += ' <div class="dropdown-menu dropdown-caret dropdown-menu-right">							 <div class="input-group">								<input class="form-control" placeholder="' + g.placeholder + '" type="text" data-edit="' + g.name + '" />								<span class="input-group-btn">									<button class="btn btn-sm ' + g.button_class + '" type="button">' + g.button_text + "</button>								</span>							 </div>						</div> </div>";
                    break;
                case "insertImage":
                    b += ' <div class="btn-group"> <a class="btn btn-sm ' + h + ' dropdown-toggle" data-toggle="dropdown" title="' + g.title + '"><i class="' + ace.vars.icon + g.icon + '"></i></a> ',
                    b += ' <div class="dropdown-menu dropdown-caret dropdown-menu-right">							 <div class="input-group">								<input class="form-control" placeholder="' + g.placeholder + '" type="text" data-edit="' + g.name + '" />								<span class="input-group-btn">									<button class="btn btn-sm ' + g.button_insert_class + '" type="button">' + g.button_insert + "</button>								</span>							 </div>",
                    g.choose_file && "FileReader" in window && (b += '<div class="space-2"></div>							 <label class="center block no-margin-bottom">								<button class="btn btn-sm ' + g.button_class + ' wysiwyg-choose-file" type="button">' + g.button_text + '</button>								<input type="file" data-edit="' + g.name + '" />							  </label>'),
                    b += " </div> </div>";
                    break;
                case "foreColor":
                case "backColor":
                    b += ' <select class="hide wysiwyg_colorpicker" title="' + g.title + '"> ',
                    a.each(g.values,
                    function(a, c) {
                        b += ' <option value="' + c + '">' + c + "</option> "
                    }),
                    b += " </select> ",
                    b += ' <input style="display:none;" disabled class="hide" type="text" data-edit="' + g.name + '" /> ';
                    break;
                case "viewSource":
            ...
            b += " </div> ";
            var k;
            c.speech_button && "onwebkitspeechchange" in (k = document.createElement("input")) && (b += ' <input class="wysiwyg-speech-input" type="text" data-edit="inserttext" x-webkit-speech />'),
            k = null,
            b += " </div> ",
            b = c.toolbar_place ? c.toolbar_place.call(this, b) : a(this).before(b).prev(),
            b.find("a[title]").tooltip({
                animation: !1,
                container: "body"
            }),
            b.find(".dropdown-menu input[type=text]").on("click",
            function() {
                return ! 1
            }).on("change",
            function() {
            ...
            b.find("input[type=file]").prev().on(ace.click_event,
            function() {
                a(this).next().click()
            }),
            ...
            var l = a(this),
            m = !1;
            b.find("a[data-view=source]").on("click",
            function(b) {
...
function(a, b) {
    ...
    a.fn.ace_spinner = function(d, e) {
        var f, g = this.each(function() {
            ...
            h = "object" == typeof d && d;
            g || (h = a.extend({},
            a.fn.ace_spinner.defaults, d), b.data("ace_spinner", g = new c(this, h))),
            "string" == typeof d && (f = g._call(d, e))
        });
        return f === b ? g: f
    },
...
function(a) {
    a.fn.aceTree = a.fn.ace_tree = function(b) {
        ...
        return this.each(function() {
            ...
            c, b, d),
            f = a(this);
            f.addClass("tree").attr("role", "tree"),
            f.html('<li class="tree-branch hide" data-template="treebranch" role="treeitem" aria-expanded="false">				<div class="tree-branch-header">					<span class="tree-branch-name">						<i class="icon-folder ' + e["close-icon"] + '"></i>						<span class="tree-label"></span>					</span>				</div>				<ul class="tree-branch-children" role="group"></ul>				<div class="tree-loader" role="alert">' + e.loadingHTML + '</div>			</div>			<li class="tree-item hide" data-template="treeitem" role="treeitem">				<span class="tree-item-name">				  ' + (null == e["unselected-icon"] ? "": '<i class="icon-item ' + e["unselected-icon"] + '"></i>') + '				  <span class="tree-label"></span>				</span>			</li>'),
            f.addClass(1 == e.selectable ? "tree-selectable": "tree-unselectable"),
            f.tree(e)
        }),
        this
    }
...
function(a) {
    a.fn.aceWizard = a.fn.ace_wizard = function(b) {
        return this.each(function() {
            var c = a(this);
            c.wizard(),
            ace.vars.old_ie && c.find("ul.steps > li").last().addClass("last-child");
            var d = b && b.buttons ? a(b.buttons) : c.siblings(".wizard-actions").eq(0),
            e = c.data("fu.wizard");
            e.$prevBtn.remove(),
            e.$nextBtn.remove(),
            e.$prevBtn = d.find(".btn-prev").eq(0).on(ace.click_event,
            function() {
                e.previous()
            }).attr("disabled", "disabled"),
            e.$nextBtn = d.find(".btn-next").eq(0).on(ace.click_event,
            function() {
                e.next()
            }).removeAttr("disabled"),
            e.nextText = e.$nextBtn.text();
...
function(a, b) {
    function c(b, c) {
        ...
        if (this.settings = a.extend({},
        a.fn.ace_aside.defaults, c, j), !this.settings.background || c.scroll_style || j.scroll_style || (this.settings.scroll_style = "scroll-white no-track"), this.container = this.settings.container, this.container) try {
        ...
        this.initiate = function() {
            b.className = b.className.replace(/(\s|^)aside\-(right|top|left|bottom)(\s|$)/gi, "$1$3"),
            g = this.settings.placement,
            g && (g = a.trim(g.toLowerCase())),
            g && /right|top|left|bottom/.test(g) || (g = "right"),
            f.attr("data-placement", g),
            f.addClass("aside-" + g),
            /right|left/.test(g) ? (h = !0, f.addClass("aside-vc")) : f.addClass("aside-hz"),
            this.settings.fixed && f.addClass("aside-fixed"),
            this.settings.background && f.addClass("aside-dark"),
            this.settings.offset && f.addClass("navbar-offset"),
            this.settings.transition || f.addClass("transition-off"),
            f.addClass("aside-hidden"),
            this.insideContainer(),
            l = f.find(".modal-dialog"),
            m = f.find(".modal-content"),
            this.settings.body_scroll || f.on("mousewheel.aside DOMMouseScroll.aside touchmove.aside pointermove.aside",
            function(b) {
        ...
        this.show = function() {
            ...
            this.container ? a(this.container).addClass("overflow-hidden") : f.css("position", "fixed"),
            f.removeClass("aside-hidden")
        },
        this.hide = function() {
            this.container && (this.container.addClass("overflow-hidden"), ace.vars.firefox && b.offsetHeight),
            o(),
            ace.vars.transition && !i && f.one("bsTransitionEnd",
            function() {
                f.addClass("aside-hidden"),
                f.css("position", ""),
                e.container && e.container.removeClass("overflow-hidden")
        ...
        this.shown = function() {
            ...
            d.off("resize.modal.aside").on("resize.modal.aside",
            function() {
            ...
            e.container && ace.vars.transition && !i && f.one("bsTransitionEnd",
            function() {
        ...
        this.hidden = function() {
            d.off(".aside"),
            (!ace.vars.transition || i) && (f.addClass("aside-hidden"), f.css("position", ""))
        },
        this.insideContainer = function() {
            ...
            if (c.css({
                ...
                var e = !1;
                1 == h && (c.css(g, parseInt((d.width() - b.width()) / 2)), e = !0),
                e && ace.vars.firefox && ace.helper.redraw(b[0])
            }
        },
        this.flip = function() {
            var a = {
            ...
            f.removeClass("aside-" + g).addClass("aside-" + a[g]),
            g = a[g]
        };
        var o = function() {
        ...
        this.initiate(),
        this.container && (this.container = a(this.container)),
        f.appendTo(this.container || "body")
    }
    var d = a(window);
    a(document).on("show.bs.modal", ".modal.aside",
    function() {
        a(".aside.in").modal("hide"),
        a(this).ace_aside("show")
    }).on("hide.bs.modal", ".modal.aside",
    function() {
        a(this).ace_aside("hide")
    }).on("shown.bs.modal", ".modal.aside",
    function() {
        a(this).ace_aside("shown")
    }).on("hidden.bs.modal", ".modal.aside",
    function() {
        a(this).ace_aside("hidden")
    }),
    a(window).on("resize.aside_container",
    function() {
        a(".modal.aside").ace_aside("insideContainer")
    }),
    a(document).on("settings.ace.aside",
    function(b, c) {
    ...
    a.fn.aceAside = a.fn.ace_aside = function(d, e) {
        var f, g = this.each(function() {
            ...
            g = b.data("ace_aside"),
            h = "object" == typeof d && d;
            g || b.data("ace_aside", g = new c(this, h)),
            "string" == typeof d && "function" == typeof g[d] && (f = e instanceof Array ? g[d].apply(g, e) : g[d](e))
        });
        return f === b ? g: f
    },
