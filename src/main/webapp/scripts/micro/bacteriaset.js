...
TSLAB.Custom=(function(){
    var cache = {
        listUrl:"../micro/bacteria/getList"
    };
    var public = {
        initGrid:function(){
            $('#tableList').jqGrid({
                ...
                mtype: "GET",
                datatype: "json",
                colNames: ['id', '类型', '编号','名称','英文名'],
                colModel: [
                    { name: 'id', index: 'id', width: 60,hidden:true},
                    { name: 'testclass', index: 'testclass', width: 100},
        ...
        Add:function(){
            ...
            layer.open({
                ...
                yes: function(index, layero){
                    //$("#addForm").submit();
                    $.ajax({
                        url:'../micro/bacteria/saveBacteria',
                        type:"POST",
                        dataType:"json",
        ...
        Delete:function(){
            ...
            layer.confirm('确定删除选择数据？', {icon: 2, title:'警告'}, function(index){
                $.post('../micro/bacteria/deleteBacteria',{id:id},function(data) {
