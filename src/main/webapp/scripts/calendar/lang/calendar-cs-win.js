...
// ** I18N
Calendar._DN  = ['Ned�le','Pond�l�','�ter�','St�eda','�tvrtek','P�tek','Sobota','Ned�le'];
Calendar._SDN = ['Ne','Po','�t','St','�t','P�','So','Ne'];
Calendar._MN  = ['Leden','�nor','B�ezen','Duben','Kv�ten','�erven','�ervenec','Srpen','Z���','��jen','Listopad','Prosinec'];
Calendar._SMN = ['Led','�no','B�e','Dub','Kv�','�rv','�vc','Srp','Z��','��j','Lis','Pro'];
