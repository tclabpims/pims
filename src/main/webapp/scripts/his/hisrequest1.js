...
function addSample() {
	...
	$("#reqitemids").val($("#reqitemids2").val());//多个项目id之间用逗号隔开(项目id1,项目id2,项目id3)
	$("#reqitemnames").val($("#reqitemnames2").val());//多个项目名称之间用逗号隔开(项目名称1,项目名称2,项目名称3)
	...
	$("#reqpathologyid").val($("#logylibid").val());
