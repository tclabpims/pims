...
<div class="row" id="toolbar">
    <div class="col-xs-12">
        <div  style="padding-top: 5px;">
            ...
            <button type="button" class="btn btn-sm btn-danger" title="清除明细" onclick="TSLAB.Custom.Delete()">
...
<div id="addDialog" style="display: none;overflow: hidden">
    <form id="addForm" class="form-horizontal" action="<c:url value='../micro/cultureresult/save'/>" method="post">
        ...
        <div class="form-group">
            ...
            <label class="col-xs-2 control-label no-padding-right" for="testCaseName">检验目的 </label>
            <div class="col-xs-10">
                <input type="text" id="testCaseName" name="testCaseName" placeholder="名称" class="col-xs-11" readonly/>
            </div>
        </div>
        <div class="form-group">
            <div class="panel panel-default" style="border:none !important;">
                <div class="panel-body" style="margin: 0px 15px !important;">
                    <select multiple="multiple" size="8" name="cultureMediumList" id="cultureMediumList">
                    </select>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="<c:url value="/scripts/micro/testcase.js"/>"></script>
