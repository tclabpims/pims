...
<div class="row" id="maincontent">
                    ...
                    <div class="scroll-content">
                        <div class="content" id="searchcontent">
                            <div style="display:inline-block;width:100%"><label>医嘱类型：</label>
                                <select id="q_specialCheck" style="height: 20px;width:150px;margin-left:-4px;">
                                    <option value="">--请选择--</option>
                                </select>
                            </div>
                            <div style="display:inline-block;width:150%"><label>申请年月：</label><input type="text" id="q_startDate"
                                                            style="width: 100px;height: 20px;">~<input type="text"
                            ...
                            <div style="display:inline-block;width:100%"><label>病人名称：</label><input type="text" id="q_patientName" style="width: 150px;height: 20px;">
        ...
        <div class="widget-box widget-color-green ui-sortable-handle">
            ...
            <div class="widget-body" style="display: block;">
                <div id="tabs" style="margin: 0 auto;background-color: #F9F9F9;border-radius: 0px;">
                    ...
                    <div id="tabs-1" style="border: 0;padding-bottom: 10px">
                        <div style="margin-bottom: 3px">
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">病理号：</label>
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="sampathologycode">
                            </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="saminspectionid">
                            </div>
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">年龄：</label>
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="sampatientage">
                            </div>
                            <div class="col-sm-3">
                                <label style="display:inline-block;width:35%;text-align:right;font-size:12px">病人姓名：</label>
                                <input type="text" style="width:35%;border-width: 1px" disabled id="sampatientname">
                        ...
                        <div style="margin-bottom: 3px">
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="sampatientgender">
                            </div>
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">送检医生：</label>
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="samsenddoctorid">
                            </div>
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">住院号：</label>
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="sampatientnumber">
                            </div>
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">登记时间：</label>
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="samregisttime">
                            </div>
                            <div style="clear:both"></div>
                        ...
                        <div style="margin-bottom: 3px">
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="samdeptname">
                            </div>
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">床号：</label>
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="sampatientbed">
                            </div>
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">末次月经：</label>
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="reqlastmenstruation">
                            </div>
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">送检医院：</label>
                                <input type="text" class="col-sm-7" style="border-width: 1px" disabled id="samsendhospital">
                            </div>
                            <div style="clear:both"></div>
                        ...
                        <div>
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="col-sm-7" id="qcsj" disabled style="height: 20px">
                            </div>
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">送检材料：</label>
                                <input type="text" id="samsamplename" style="border-width: 1px;height:20px;padding-bottom:0px;" disabled class="col-sm-7"></input>
                            </div>
                            <div class="col-sm-3">
                                <label style="text-align:right;font-size:12px" class="col-sm-5">临床诊断：</label>
                                <input type="text" id="sampatientdignoses" style="border-width: 1px;height:20px;padding-bottom:0px;" disabled class="col-sm-7"></input>
                            </div>
                            <div style="clear:both"></div>
                        </div>
    ...
    <div id="takingPicture">
        <div class="widget-box widget-color-green ui-sortable-handle" style="min-height: 600px">
            <div class="widget-header">
            ...
            <div class="widget-body" style="margin-top:10px;padding-right: 3px">
                <div style="height: 20px;;font-weight:bold;">白片信息</div>
                <div style="padding-top:5px;" id="lakuaiListContainer">
