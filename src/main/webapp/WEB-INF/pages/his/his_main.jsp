...
<body style="font-family:'Microsoft YaHei',微软雅黑,'MicrosoftJhengHei'!important;">
	<div id="h5_1">
		<h5 style="float: left;width: 100%;background-clip:content-box;background-color:rgb(135,184,127);height:40px;font-size:15px;color:#fff;line-height:40px;margin-top:0px!important;"><strong>&nbsp;&nbsp;申请登记</strong></h5>
	</div>
	<div>
			...
			<form class="form-horizontal" action="#" method="post" id="sampleForm" onkeypress="JavaScript:return NoSubmit(event);">
				...
				<div class="form-group" style="z-index: 99999999;margin-bottom: 5px">
					...
					<div class="col-sm-2">
						...
						<input id="reqitemnames"  name="reqitemnames" datatype="*" style="position:absolute;left:5px;width: 73%" class="input_style" ${reqitemnames}>
					</div>
