...
<body style="font-family:'Microsoft YaHei',微软雅黑,'MicrosoftJhengHei'!important;">
	...
	<%--修改--%>
	<%--</button>--%>
	<button type="button" class="btn btn-sm btn-warning " title="删除" id="deleteButton" onclick="deleteSample()">
	...
	<button type="button" class="btn btn-sm btn-info " title="打印" onclick="printSlide()">
		<i class="ace-icon fa fa-print bigger-110"></i>
		打印送检物
	</button>
</div>
	<div id="h5_1">
		<h5 style="float: left;width: 34%;font-size: 14px;"><strong>&nbsp;<img src="/styles/imagepims/list.png" class="img_style">&nbsp;已登记申请一览</strong></h5>
		<h5  style="float: left;width: 66%;font-size: 14px;margin-bottom: 12px"><strong>&nbsp;<img src="/styles/imagepims/main.png" class="img_style">&nbsp;申请登记</strong></h5>
	</div>
	<div>
			...
			<form class="form-horizontal" action="#" method="post" id="sampleForm" onkeypress="JavaScript:return NoSubmit(event);">
				...
				<div class="form-group" style="margin-bottom: 5px">
					...
					<div class="col-sm-2">
						...
						<input id="reqdoctorname"  name="reqdoctorname" datatype="*" style="position:absolute;left:5px;width: 73%" class="input_style" value="${reqdoctorname1}" >
					</div>
					...
					<div class="col-sm-2">
						...
						<input id="reqsendhospital"  name="reqsendhospital" datatype="*" style="position:absolute;left:5px;width: 73%" class="input_style" value="${reqsendhospital1}">
					</div>
				</div>
				<div class="form-group" style="margin-bottom: 5px">
					...
					<div class="col-sm-2">
						...
						<input id="reqdeptname"  name="reqdeptname" datatype="*" style="position:absolute;left:5px;width: 73%" class="input_style" value="${reqdeptname1}">
					</div>
					...
					<div class="col-sm-2">
						...
						<input id="reqwardname"  name="reqwardname" datatype="*" style="position:absolute;left:5px;width: 73%" class="input_style" value="${reqwardname1}">
					</div>
				</div>
				<div class="form-group" style="margin-bottom: 5px;">
