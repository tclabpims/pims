                    ...
                    <div class="cell"><fmt:message key="label.pathologyLib"/>
                       <span class="block input-icon input-icon-right">
                        <select name="pathologyLibId" id="pathologyLibId">
                            <option name="" value="15">骨髓细胞学</option>
                            <option name="" value="16">免疫组化</option>
                            <option name="" value="17">常规细胞学</option>
                            <option name="" value="18">液基细胞学</option>
                            <option name="" value="20">病理会诊</option>
                            <option name="" value="32">常规病理</option>
                            <option name="" value="34">术中冰冻</option>
                            <option name="" value="35">HPV</option>
                            <option name="" value="36">外周血细胞</option>
                        </select>
                        <i class="ace-icon fa fa-lock"></i>
